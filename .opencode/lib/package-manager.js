 ...
 *
 * Migrated from: scripts/lib/package-manager.js
 ...
 * 5. Global user preference (in ~/.opencode/package-manager.json)
...
function getSelectionPrompt() {
  ...
  message += '  - Or add to ~/.opencode/package-manager.json: {"packageManager": "pnpm"}\n';
