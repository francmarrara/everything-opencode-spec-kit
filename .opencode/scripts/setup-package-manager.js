#!/usr/bin/env node
/**
 * Package Manager Setup Script (OpenCode-adapted)
 *
 * Interactive script to configure preferred package manager.
 * Can be run directly or via the /setup-pm command.
 *
 * Usage:
 *   node .opencode/scripts/setup-package-manager.js [pm-name]
 *   node .opencode/scripts/setup-package-manager.js --detect
 *   node .opencode/scripts/setup-package-manager.js --global pnpm
 *   node .opencode/scripts/setup-package-manager.js --project bun
 */
...
Usage:
  node .opencode/scripts/setup-package-manager.js [options] [package-manager]
...
Examples:
  ...
  node .opencode/scripts/setup-package-manager.js --list
`);
}
